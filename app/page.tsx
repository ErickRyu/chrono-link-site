      ...
      <main>
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-8 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-light text-gray-800">기존 앱들의 한계를 느끼고 직접 Powerdoro 앱을 개발하여 개인적 니즈 해결.</p>
                </div>
              </div>

              <div className="flex gap-8 items-start">
                <div className="w-20 text-right">
                  <div className="text-sm font-light text-gray-700 tracking-wider uppercase">Aug 2025</div>
                </div>
        ...
        <section className="py-40 bg-[#FAFAFA]">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <p className="text-xl font-light text-gray-800 mb-16">
